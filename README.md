...
In your Gemfile you need to add the `bootstrap-sass` gem, and ensure that the `sassc-rails` gem is present - it is added to new Rails applications by default.
